...
public class Interp extends MyBase<Memory> {
    ...
    public Memory dereference(NodeToken t, Memory register) {
        ...
        Memory val=((kanga.memory.Reg)register).getVal();
        return val;
    }
    ...
    */
    public Memory visit(CJumpStmt n) {
    	kanga.memory.Reg reg = (kanga.memory.Reg)n.f1.accept(this);
        ...
        kanga.memory.Int i = ((kanga.memory.Int)possibleInt);
        
        if (i.getInt()==1) {
            runtime.pc++;
        } else {
        	kanga.memory.Label label = (kanga.memory.Label)n.f2.accept(this);
    ...
    */
    public Memory visit(JumpStmt n) {
    	kanga.memory.Label label = (kanga.memory.Label)n.f1.accept(this);
        if (label==null) {
            runtime.exception=true;
            return null;
        }
    ...
    */
    public Memory visit(HStoreStmt n) {
        runtime.hstore++;
        kanga.memory.Reg memLoc = (kanga.memory.Reg)n.f1.accept(this);
        ...
        kanga.memory.Reg val = (kanga.memory.Reg)n.f3.accept(this);
        try {
    ...
    */
    public Memory visit(HLoadStmt n) {
        runtime.hload++;
        kanga.memory.Reg destReg = (kanga.memory.Reg)n.f1.accept(this);

        kanga.memory.Reg memLoc = (kanga.memory.Reg)n.f2.accept(this);
    ...
    */
    public Memory visit(PrintStmt n) {
        ...
        if (exp==null ||
            ...
            String cmd = ((kanga.memory.Internal)exp).cmd;
    ...
    */
    public Memory visit(AStoreStmt n) {
        ...
        kanga.memory.Reg reg = (kanga.memory.Reg)n.f2.accept(this);
    ...
    */
    public Memory visit(CallStmt n) {
        ...
        kanga.memory.Label label = (kanga.memory.Label)exp;
    ...
    */
    public Memory visit(HAllocate n) {
        ...
        int val = ((kanga.memory.Int)arg).getInt();
        Heap heap;
        try {
            heap = new Heap(val);
        } catch (KangaException e) {
    ...
    */
    public Memory visit(BinOp n) {
        ...
        {
        	if (exp1.isHeap() || exp2.isHeap())
        	{
        		return runtime.getInt(new String(""+binop(op, 0, 1)));
        	}
        }
        ...
        } else
        {
        	...
        	{
		        	if ((exp1.isHeap() && exp2.isInt()) ||
		                   (exp2.isHeap() && exp1.isInt())) {
		        	kanga.memory.Heap heap;
		            int offset1, offset2, offset;
		            if (exp1.isHeap()) {
		                heap=(Heap)exp1;
		                offset1=heap.getOffset();
		                offset2=((kanga.memory.Int)exp2).getInt();
		                offset=binop(op, offset1, offset2);
		            } else {
		                heap=(Heap)exp2;
		                offset1=((kanga.memory.Int)exp1).getInt();
    ...
    *       | "v1"
    */
    public Memory visit(kanga.syntaxtree.Reg n) {
    ...
    * f0 -> <IDENTIFIER>
    */
    public Memory visit(kanga.syntaxtree.Label n) {
        ...
        if (Environment.allowDumps && 
            ...
            return new kanga.memory.Internal(id);
