...
public class SetLabel extends GJNoArguDepthFirst<Object> {
    ...
    public Object visit(Goal n) {
        ...
        try {
            newStack = new kanga.memory.Stack(params, stackSize, maxArgSize, 
                                        -999, false);
    ...
    public Object visit(StmtList n) {
        for (Enumeration e=n.f0.elements(); 
            ...
            if (no.present()) {
                ...
                runtime.labelHash.put(label, new kanga.memory.Label(label, count));
            }
     ...
     * f0 -> <IDENTIFIER>
     */
    public Object visit(kanga.syntaxtree.Label n) {
        return n.f0.toString();
    }
