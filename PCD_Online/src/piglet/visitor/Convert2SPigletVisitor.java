...
{	
	...
	public PExp visit(NodeList n, Node argu) throws RuntimeError//结点列表
	{
		PExp ret = null;
	...
	public PExp visit(NodeListOptional n, Node argu) throws RuntimeError//可选结点列表
	{
		PExp ret = null;
		if (n.present())
		{
	...
	public PExp visit(NodeOptional n, Node argu) throws RuntimeError//可选结点
	{
		if (n.present())
		{
	...
	public PExp visit(NodeSequence n, Node argu) throws RuntimeError//结点序列
	{
		PExp ret = null;
		for (Enumeration<Node> e = n.elements(); e.hasMoreElements();)
		{
	 ...
	 * f4 -> <EOF>
	 */
	public PExp visit(Goal n, Node argu) throws RuntimeError//主程序体
	{
		println("MAIN");
	 ...
	 * f0 -> ( ( Label() )? Stmt() )*
	 */
	public PExp visit(StmtList n, Node argu) throws RuntimeError//多个语句
	{
		n.f0.accept(this, n);
		return null;
	}
	 ...
	 * f4 -> StmtExp()
	 */
	public PExp visit(Procedure n, Node argu) throws RuntimeError//过程
	{
		println();//换行隔开
	 ...
	 *       | PrintStmt()
	 */
	public PExp visit(Stmt n, Node argu) throws RuntimeError//语句
	{
		n.f0.accept(this, n);
		return null;
	}
	 ...
	 * f0 -> "NOOP"
	 */
	public PExp visit(NoOpStmt n, Node argu)
	{
		println("NOOP");
		return null;
	}
	 ...
	 * f0 -> "ERROR"
	 */
	public PExp visit(ErrorStmt n, Node argu) throws RuntimeError//ERROR
	{
		println("ERROR");
		return null;
	}
	 ...
	 * f2 -> Label()
	 */
	public PExp visit(CJumpStmt n, Node argu) throws RuntimeError//条件跳转
	{
	 ...
	 * f1 -> Label()
	 */
	public PExp visit(JumpStmt n, Node argu) throws RuntimeError//跳转
	{
	 ...
	 * f3 -> Exp()
	 */
	public PExp visit(HStoreStmt n, Node argu) throws RuntimeError//存储
	{
		PExp exp1 = n.f1.accept(this, n);
		PExp exp2 = n.f2.accept(this, n);
	 ...
	 * f3 -> IntegerLiteral()
	 */
	public PExp visit(HLoadStmt n, Node argu) throws RuntimeError//读取
	{
		PExp exp1 = n.f1.accept(this, n);
		PExp exp2 = n.f2.accept(this, n);
		PExp exp3 = n.f3.accept(this, n);
	 ...
	 * f2 -> Exp()
	 */
	public PExp visit(MoveStmt n, Node argu) throws RuntimeError//移入
	{
		PExp exp1 = n.f1.accept(this, n);
		PExp exp2 = n.f2.accept(this, n);
	 ...
	 * f1 -> Exp()
	 */
	public PExp visit(PrintStmt n, Node argu) throws RuntimeError//打印
	{
		PExp exp = n.f1.accept(this, n);
	 ...
	 *       | Label()
	 */
	public PExp visit(Exp n, Node argu) throws RuntimeError//表达式
	{
	 ...
	 * f4 -> "END"
	 */
	public PExp visit(StmtExp n, Node argu) throws RuntimeError//语句表达式
	{
		PExp ret = null;
	 ...
	 * f4 -> ")"
	 */
	public PExp visit(Call n, Node argu) throws RuntimeError//过程调用
	{
		PExp exp1 = n.f1.accept(this, n);
	 ...
	 * f1 -> Exp()
	 */
	public PExp visit(HAllocate n, Node argu) throws RuntimeError//分配内存
	{
		PExp exp = n.f1.accept(this, n);
	 ...
	 * f2 -> Exp()
	 */
	public PExp visit(BinOp n, Node argu) throws RuntimeError
	{
	 ...
	 *       | "TIMES"
	 */
	public PExp visit(Operator n, Node argu) throws RuntimeError//比较运算符
	{
	 ...
	 * f1 -> IntegerLiteral()
	 */
	public PExp visit(Temp n, Node argu)
	{
	 ...
	 * f0 -> <IDENTIFIER>
	 */
	public PExp visit(Label n, Node argu)
	{
		return new PExp(n.f0.toString(), PExp.SIMPLE);
	}
}
