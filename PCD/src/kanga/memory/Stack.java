...
public class Stack {
    ...
    public void copyCallArgToStack(kanga.memory.Stack destStack) throws KangaException {
    ...
    public void copyStackToCallArg(kanga.memory.Stack destStack) throws KangaException {
