 ...
 */
public class LivenessAnalyzerVisitor extends GJVoidDepthFirst<SStatement>//活性分析
{
	/**
	 * f0 -> "HLOAD"
	 * f1 -> Temp()
	...
	{
		int nTemp = Integer.parseInt(n.f1.f0.tokenImage);
		argu.addLiveUse(nTemp);//值的使用 
	}
}
